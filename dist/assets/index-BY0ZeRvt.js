import{v as $,F as _,G as R,i as f,r as m,a as b,x as l,O as a,j as O}from"./index-DjICIIT5.js";import{n as j,c as w,o as P,r as y}from"./if-defined-DtFz36zK.js";import{e as T,n as U}from"./ref-CRgLwM4H.js";import{R as B}from"./ConstantsUtil-Dmg8YACJ.js";const u=$({isLegalCheckboxChecked:!1}),g={state:u,subscribe(n){return R(u,()=>n(u))},subscribeKey(n,e){return _(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},E=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var C=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var s=n.length-1;s>=0;s--)(c=n[s])&&(t=(i<3?c(t):i>3?c(e,r,t):c(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let d=class extends b{constructor(){super(),this.unsubscribe=[],this.remoteFeatures=a.state.remoteFeatures,this.unsubscribe.push(a.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:r}=a.state,o=a.state.features?.legalCheckbox;return!e&&!r||o?l`
    ...
    >`:null}privacyTemplate(){const{privacyPolicyUrl:e}=a.state;return e?l`<a href=${e} target="_blank" rel="noopener noreferrer"
      >Privacy Policy</a
    >`:null}reownBrandingTemplate(e=!1){return this.remoteFeatures?.reownBranding?e?l`<wui-ux-by-reown class="branding-only"></wui-ux-by-reown>`:l`<wui-ux-by-reown></wui-ux-by-reown>`:null}};d.styles=[D];C([y()],d.prototype,"remoteFeatures",void 0);d=C([w("w3m-legal-footer")],d);export{g as O};
